...
data_prices_feb_25 = {
    ...
    1: [15.5, None, 22.9, 28.6, 32, 36.5, None, 4.83, 13.73, 19.73, 24.73, 15.5, 24.4, 30.4, 35.4, 41, 30.33,29.5],
    2: [12.15, None, 19.55, 25.25, 28.65, 33.15, None, 4.83, 13.73, 19.73, 24.73, 12.15, 21.05, 27.05, 32.55, 37.65, 30.33,26.15],
    3: [12.65, None, 20.05, 25.75, 29.15, 33.65, None, 4.83, 13.73, 19.73, 24.73, 12.65, 21.55, 27.55, 32.55, 38.15, 30.33,26.65],
    4: [13.65, None, 21.05, 26.75, 30.15, 34.65, None, 4.83, 13.73, 19.73, 24.73, 13.65, 22.55, 28.55, 33.55, 39.15, 30.33,27.65],
    5: [14, None, 21.4, 27.1, 30.5, 35, None, 4.83, 13.73, 19.73, 24.73, 14, 22.9, 28.9, 33.9, 39.5, 30.33,28],
    6: [14.5, None, 21.9, 27.6, 31, 35.5, None, 4.83, 13.73, 19.73, 24.73, 14.5, 23.4, 29.4, 34.4, 40, 30.33,28.5],
    7: [15, None, 22.4, 28.1, 31.5, 36, None, 4.83, 13.73, 19.73, 24.73, 15, 23.9, 29.9, 34.9, 40.5, 30.33,29],
    8: [16, None, 23.4, 29.1, 32.5, 37, None, 4.83, 13.73, 19.73, 24.73, 16, 24.9, 30.9, 35.9, 41.5, 30.33,30]
}
...
df_merged['Comisión en pesos'] = np.where(
    df_merged['original_date'] >= pd.Timestamp("2025-02-24"),
    np.where(
